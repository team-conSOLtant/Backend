...
import com.consoltant.consoltant.util.api.dto.createdeposit.CreateDepositResponseDto;
import com.consoltant.consoltant.util.api.dto.createdepositaccount.CreateDepositAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.createloanaccount.CreateLoanAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.createloanapplication.CreateLoanApplicationResponseDto;
import com.consoltant.consoltant.util.api.dto.createloanproduct.CreateLoanProductResponseDto;
import com.consoltant.consoltant.util.api.dto.createproduct.CreateProductResponseDto;
import com.consoltant.consoltant.util.api.dto.createsavingaccount.CreateSavingAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.deletedepositaccount.DeleteDepositAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.deletesavingaccount.DeleteSavingAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.inquireassetbasedcreditrating.InquireAssetBasedCreditRatingResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiredemanddeposit.InquireDemandDepositResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiredemanddepositaccount.InquireDemandDepositAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiredemanddepositaccountbalance.InquireDemandDepositAccountBalanceResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiredepositinfo.InquireDepositInfoResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiredepositproducts.InquireDepositProductsResponseDto;
import com.consoltant.consoltant.util.api.dto.inquireloanaccount.InquireLoanAccountResponseDto;
import com.consoltant.consoltant.util.api.dto.inquireloanapplication.InquireLoanApplicationResponseDto;
import com.consoltant.consoltant.util.api.dto.inquireloanproduct.InquireLoanProductResponseDto;
...
import com.consoltant.consoltant.util.api.dto.inquiresavingproducts.InquireSavingProductsResponseDto;
import com.consoltant.consoltant.util.api.dto.inquiretransactionhisotrylist.InquireTransactionHistoryListResponseDto;
